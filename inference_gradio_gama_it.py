...
# tokenizer = LlamaTokenizer.from_pretrained('/fs/nexus-projects/brain_project/acl_sk_24/GAMA//train_script/Llama-2-7b-chat-hf-qformer')
# if device == 'cuda':
#     model = LlamaForCausalLM.from_pretrained('/fs/nexus-projects/brain_project/acl_sk_24/GAMA//train_script/Llama-2-7b-chat-hf-qformer', device_map="auto", torch_dtype=torch.float16)
# else:
#     model = LlamaForCausalLM.from_pretrained('/fs/nexus-projects/brain_project/acl_sk_24/GAMA//train_script/Llama-2-7b-chat-hf-qformer', device_map="auto")
...
# state_dict = torch.load('/fs/gamma-projects/audio/gama/new_data/stage5_all_mix_all/checkpoint-900/pytorch_model.bin', map_location='cpu')
