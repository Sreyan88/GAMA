...
def convert_file(
    ...
    wts = loaded['state_dict'].copy()

    for key in list(wts.keys()):
        if 'module.audio_branch.' in key:
            wts[key.replace('module.audio_branch.','model.audio_encoder.')] = wts[key]
            del wts[key]
        else:
            del wts[key]
...
convert_file("/fs/nexus-projects/brain_project/acl_sk_24/reclap_large.pt", "model-00003-of-00002_large.safetensors", None)